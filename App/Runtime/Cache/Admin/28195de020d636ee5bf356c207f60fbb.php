	...
	<!-- end #sidebar -->
        ...
        <div id="content" class="content">
            ...
            <ol class="breadcrumb pull-right">
                ...
                <li class="active">管理评论信息</li>
            </ol>
            <!-- end breadcrumb -->
            <!-- begin page-header -->
            <h1 class="page-header" style="color:#39f">管理评论信息 <small>页眉内容写在这里...</small></h1>
            <!-- end page-header -->
                                ...
                                <table id="data-table" class="table table-striped table-bordered" style="text-align:center">
                                    <thead>
                                        <tr style="background-color:#69c;" >
                                            ...
                                            <th style="text-align:center;">评论者id</th>
                                            <th style="text-align:center;">博客id</th>
                                            <th style="text-align:center;">评论内容</th>
                                            <th style="text-align:center;">评论时间</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php if(is_array($commentInfo)): $i = 0; $__LIST__ = $commentInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
