...
<script type="text/javascript" src="/blog/Public/ueditor/lang/zh-cn/zh-cn.js"></script>
      <header class="news_header">
        ...
        <ul>
          ...
          <?php if($uid == $blogData['user_id']): ?><li style="text-decoration: underline;cursor: pointer;" id="edit">编辑</li><?php endif; ?>
        </ul>
      </header>
      ...
      <form class="form-horizontal hide" id="edit_blog">
        <textarea id="content" required><?php echo ($blogData["content"]); ?></textarea><br/>
        <input type="text" id="title" required class="form-control" placeholder="博客标题,必填" value="<?php echo ($blogData["title"]); ?>"/><br/>
        <input type="text" id="type" required class="form-control" placeholder="博客分类,必填,例如php,mysql,js。只能写一种" value="<?php echo ($blogData["type"]); ?>" />
        <br/>
        <div class="container">
         <button type="submit" id="blog-btn" blogId="<?php echo ($blogData["id"]); ?>" style="margin:12px" class="btn btn-info">保存博客</button>
        </div>
      </form>
          ...
          <div class="comment-form">
            ...
            <div class="comment-form-footer">
              ...
              <div class="comment-form-btn">
                <button type="button" id="comment-btn" status="<?php echo ($isLogin?1:0); ?>" class="btn btn-default btn-comment" username="<?php echo ($username); ?>">提交评论</button>
              </div>
            </div>
          </div>
        </form>
               ...
               $.post("<?php echo U('Comment/comment');?>",data, function(res) {
                    ...
                    if(result.code==200){
                       ...
                       var resData=result.data,
                           html='';
                       html+='<li><span class="face"><img src="/blog/Public/Home/images/icon/icon.png" alt=""></span> <span class="text"><strong>'+username+'</strong> ('+resData.time+') 说：<br />'+content+'</span></li>';
