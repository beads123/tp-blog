		...
		<section class="container user-select">
			<header>
				...
				<ul class="nav hidden-xs-nav">
					...
					<li><a href="<?php echo U('Blog/index',array('type'=>'front'));?>"><span class="glyphicon glyphicon-erase"></span>网站前端</a></li>
				...
				<div class="wall"><a href="<?php echo U('Index/readerWall');?>" target="_blank">读者墙</a> | <a href="<?php echo U('Index/tags');?>" target="_blank">标签云</a></div>
			</div>
			<!--/超小屏幕不显示-->
...
<div class="content-block">
  ...
  <div class="face-block">
    <span class="face" data-toggle="tooltip" data-placement="bottom" title="异清轩">
      <img src="/Blog/Public/Home/images/icon/icon.png" alt=""></span>
    <span class="face" data-toggle="tooltip" data-placement="bottom" title="异清轩"><img src="/Blog/Public/Home/images/icon/icon.png" alt=""></span>
    <span class="face" data-toggle="tooltip" data-placement="bottom" title="异清轩"><img src="/Blog/Public/Home/images/icon/icon.png" alt=""></span>
    <span class="face" data-toggle="tooltip" data-placement="bottom" title="异清轩"><img src="/Blog/Public/Home/images/icon/icon.png" alt=""></span>
    <span class="face" data-toggle="tooltip" data-placement="bottom" title="异清轩"><img src="/Blog/Public/Home/images/icon/icon.png" alt=""></span>
    <span class="face" data-toggle="tooltip" data-placement="bottom" title="异清轩"><img src="/Blog/Public/Home/images/icon/icon.png" alt=""></span>
